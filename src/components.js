function MaterialComponentsNav() {
    "use strict";
    this.element_ = document.querySelector(".mdl-js-components"), this.element_ && (this.componentLinks = this.element_.querySelectorAll(".mdl-components__link"), this.activeLink = null, this.activePage = null, this.init())
}
MaterialComponentsNav.prototype.linksMap_ = {}, MaterialComponentsNav.prototype.CssClasses_ = {
    ACTIVE: "is-active"
}, MaterialComponentsNav.prototype.init = function () {
    "use strict";
    for (var t = 0; t < this.componentLinks.length; t++) this.componentLinks[t].addEventListener("click", this.clickHandler(this.componentLinks[t])), this.linksMap_["#" + this.componentLinks[t].href.split("#")[1]] = this.componentLinks[t];
    ...
    "use strict";
    this.activeLink && this.activeLink.classList.remove(this.CssClasses_.ACTIVE), this.activeLink = null, this.activePage && this.activePage.classList.remove(this.CssClasses_.ACTIVE), this.activePage = this.element_.querySelector("#Tab0"), this.activePage.classList.add(this.CssClasses_.ACTIVE)
    ...
    return function (s) {
        ...
        var e = window.location.hash.split("/")[0],
            n = t.href.split("#")[1];
        return e !== "#" + n && (history.pushState(null, "Material Design Lite", t), document.getElementById("content").scrollTop = 0, ga && ga("send", "pageview", "/components/" + n)), !0
    }.bind(this)
